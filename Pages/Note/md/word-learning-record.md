...
|单词|词性|释义|助记|
|---|---|---|---|
|moan|v./n.|呻吟，抱怨|谐音“闷”→心里烦闷→抱怨、呻吟|
|bruise|v./n.|伤痕，打击，碰伤|b+ruise→被撞出伤痕|
|book|n./v.|书，预约，打赌|熟词僻义：除书本，还有预约、下注含义|
|entrench|v.|巩固，侵犯|en‑(使)+trench(壕沟)→挖壕沟→巩固阵地|
|catering|n.|饮食服务，满足|cater(迎合)+ing→提供餐饮服务、满足需求|
|venture|n./v.|冒险|vent(来)+ure→出来闯荡→冒险|
|ventures|n.(复数)|合资企业，风险项目|venture复数，商业语境表风险项目|
|invent|v.|发明，编造|in‑(进入)+vent(来)→想出新东西→发明|
|roundabout|adj./n.|迂回的，拐弯抹角的，绕路|round(圆圈)+about→绕圈子→迂回|
|determine|v.|决定，查清，弄明，裁决|de‑(加强)+termin(界限)+e→划定界限→决定|
|instinct|n.|本能；天分；直觉|in‑(内)+stinct(刺)→内心迸发→本能、直觉|
### 2026-08-21
|单词/短语|词性|释义|助记|
|---|---|---|---|
