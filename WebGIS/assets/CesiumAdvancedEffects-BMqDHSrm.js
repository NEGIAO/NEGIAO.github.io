import{_ as ie,u as ae,r as y,q as le,Q as ue,U as fe,l as ce,a as me,o as de,b as a,f as C,t as ge,c8 as O,O as he}from"./index-CMY1cbNi.js";const pe={class:"advanced-effects-root"},be={class:"effects-panel"},Se={class:"panel-head"},ye={class:"effect-switches"},xe={class:"switch-item"},_e={class:"switch-item"},Ee={class:"switch-item"},Ce={class:"switch-item"},Ae={__name:"CesiumAdvancedEffects",props:{getViewer:{type:Function,required:!0},getCesium:{type:Function,required:!0}},setup(q){const d=q,b=ae(),A=y(null),x=y(!0),_=y(!1),v=y(!0),L=y(!0),p=y(!0);let u=null,m=null,r=null,P=!1,f=null,M=null,g=null,T=null,E=null,D=null,R=null,z=!1,H=0,N=0,V=typeof performance<"u"?performance.now():Date.now();const h={labels:[],cameraHeightKm:[],pitchDeg:[],fps:[]},i={hdr:null,bloom:null,sky:null};le(()=>{W()}),ue(()=>{re()});function W(){let t=0;g=window.setInterval(async()=>{var n,s;t+=1;const e=(n=d.getViewer)==null?void 0:n.call(d),o=((s=d.getCesium)==null?void 0:s.call(d))||window.Cesium;if(e&&o){clearInterval(g),g=null;try{Q(e),J(e),j(e,o),te(e),await oe(e,o),ne(e,o),b.success("高级视觉效果已启用。")}catch(l){b.error("高级视觉效果初始化失败",l),b.warning("高级视觉效果部分初始化失败，已自动降级。",{closable:!0})}return}t>=150&&(clearInterval(g),g=null,b.warning("高级视觉效果等待超时，未获取到 3D Viewer。"))},80)}function Q(t){var o,n,s,l,c,F;const e=t==null?void 0:t.scene;if(e){if(typeof e.highDynamicRange=="boolean"&&(i.hdr=e.highDynamicRange),(o=e.postProcessStages)!=null&&o.bloom){const S=e.postProcessStages.bloom;i.bloom={enabled:!!S.enabled,contrast:(n=S.uniforms)==null?void 0:n.contrast,brightness:(s=S.uniforms)==null?void 0:s.brightness,delta:(l=S.uniforms)==null?void 0:l.delta,sigma:(c=S.uniforms)==null?void 0:c.sigma,stepSize:(F=S.uniforms)==null?void 0:F.stepSize}}e.skyAtmosphere&&(i.sky={hueShift:e.skyAtmosphere.hueShift,saturationShift:e.skyAtmosphere.saturationShift,brightnessShift:e.skyAtmosphere.brightnessShift})}}function j(t,e){var n;!((n=t==null?void 0:t.scene)!=null&&n.postProcessStages)||!(e!=null&&e.PostProcessStage)||(Z(t,e),w(t,e),ee(t,e),G(t,1200))}function J(t){var o;const e=t==null?void 0:t.scene;(o=e==null?void 0:e.renderError)!=null&&o.addEventListener&&(e.rethrowRenderErrors=!1,R=e.renderError.addEventListener((n,s)=>{b.error("Cesium 渲染异常，已触发降级保护",s),Y(),z||(z=!0,b.warning("检测到当前设备图形兼容性问题，已自动降级高级特效以保证 3D 可用。",{closable:!0,duration:6e3}))}))}function Y(){x.value=!1,v.value=!1,_.value=!1,L.value=!1,u&&(u.enabled=!1),m&&(m.enabled=!1),r&&(r.enabled=!1)}function Z(t,e){u||(u=new e.PostProcessStage({name:"cinematic_height_fog_stage",fragmentShader:`
