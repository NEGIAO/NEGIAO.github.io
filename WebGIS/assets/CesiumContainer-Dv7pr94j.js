...
`;class T{constructor(o){this.commandType=o.commandType,this.geometry=o.geometry,this.attributeLocations=o.attributeLocations,this.primitiveType=o.primitiveType,this.uniformMap=o.uniformMap,this.vertexShaderSource=o.vertexShaderSource,this.fragmentShaderSource=o.fragmentShaderSource,this.rawRenderState=o.rawRenderState,this.framebuffer=o.framebuffer,this.isPostRender=o.isPostRender,this.outputTexture=o.outputTexture,this.autoClear=e.defaultValue(o.autoClear,!1),this.preExecute=o.preExecute,this.modelMatrix=e.defaultValue(o.modelMatrix,e.Matrix4.IDENTITY),this.show=!0,this.commandToExecute=void 0,this.clearCommand=void 0,this.autoClear&&(this.clearCommand=new e.ClearCommand({color:new e.Color(0,0,0,0),depth:1,framebuffer:this.framebuffer,pass:e.Pass.OPAQUE}))}createCommand(o){switch(this.commandType){case"Draw":{const h=e.VertexArray.fromGeometry({context:o,geometry:this.geometry,attributeLocations:this.attributeLocations,bufferUsage:e.BufferUsage.STATIC_DRAW}),p=e.ShaderProgram.fromCache({context:o,attributeLocations:this.attributeLocations,vertexShaderSource:this.vertexShaderSource,fragmentShaderSource:this.fragmentShaderSource}),m=e.RenderState.fromCache(this.rawRenderState);return new e.DrawCommand({owner:this,vertexArray:h,primitiveType:this.primitiveType,uniformMap:this.uniformMap,modelMatrix:this.modelMatrix,shaderProgram:p,framebuffer:this.framebuffer,renderState:m,pass:e.Pass.OPAQUE})}case"Compute":return new e.ComputeCommand({owner:this,fragmentShaderSource:this.fragmentShaderSource,uniformMap:this.uniformMap,outputTexture:this.outputTexture,persists:!0})}}setGeometry(o,h){this.geometry=h;const p=e.VertexArray.fromGeometry({context:o,geometry:this.geometry,attributeLocations:this.attributeLocations,bufferUsage:e.BufferUsage.STATIC_DRAW});this.commandToExecute.vertexArray=p}update(o){this.show&&(e.defined(this.commandToExecute)||(this.commandToExecute=this.createCommand(o.context),this.commandToExecute.isPostRender=this.isPostRender),e.defined(this.preExecute)&&this.preExecute(this),e.defined(this.clearCommand)&&o.commandList.push(this.clearCommand),o.commandList.push(this.commandToExecute))}isDestroyed(){return!1}destroy(){return e.defined(this.commandToExecute)&&(e.defined(this.commandToExecute.shaderProgram)&&(this.commandToExecute.shaderProgram=this.commandToExecute.shaderProgram.destroy()),e.defined(this.commandToExecute.vertexArray)&&(this.commandToExecute.vertexArray=this.commandToExecute.vertexArray.destroy())),e.destroyObject(this)}}class P{constructor(){}static loadText(o){const h=new XMLHttpRequest;return h.open("GET",o,!1),h.send(),h.responseText}static getFullscreenQuad(){return new e.Geometry({attributes:new e.GeometryAttributes({position:new e.GeometryAttribute({componentDatatype:e.ComponentDatatype.FLOAT,componentsPerAttribute:3,values:new Float32Array([-1,-1,0,1,-1,0,1,1,0,-1,1,0])}),st:new e.GeometryAttribute({componentDatatype:e.ComponentDatatype.FLOAT,componentsPerAttribute:2,values:new Float32Array([0,0,1,0,1,1,0,1])})}),indices:new Uint32Array([3,2,0,0,2,1])})}static createTexture(o){if(e.defined(o.arrayBufferView)){const p={};p.arrayBufferView=o.arrayBufferView,o.source=p,o.flipY=!1}return new e.Texture(o)}static createDepthFramebuffer(o,h,p){return new e.Framebuffer({context:o,colorTextures:[this.createTexture({context:o,width:h,height:p,flipY:!1,pixelFormat:e.PixelFormat.RGBA,pixelDatatype:e.PixelDatatype.FLOAT,arrayBufferView:new Float32Array(h*p*4)})],depthRenderbuffer:new e.Renderbuffer({context:o,width:h,height:p,format:e.RenderbufferFormat.DEPTH_COMPONENT16}),destroyAttachments:!0})}static createFramebuffer(o,h,p,m=!1){const l={context:o,colorTextures:[h],destroyAttachments:m};return p&&(l.depthTexture=p),new e.Framebuffer(l)}static createRawRenderState(o){const m={viewport:o.viewport,depthTest:o.depthTest,depthMask:o.depthMask,blending:o.blending};return e.Appearance.getDefaultRenderState(!0,!1,m)}}const C=class C{constructor(o,h={}){if(!o)throw new Error("Cesium Viewer is required");this.viewer=o,this._initConfiguration(h),this._initState(),this._createResources(),this._setupRenderPipeline()}_initConfiguration(o){this.config={resolution:new e.Cartesian2(o.width||C.DEFAULTS.width,o.height||C.DEFAULTS.height),dimensions:o.dimensions||C.DEFAULTS.dimensions.clone(),heightRange:{min:o.minHeight??C.DEFAULTS.heightRange[0],max:o.maxHeight??C.DEFAULTS.heightRange[1]},baseHeight:o.baseHeight??C.DEFAULTS.baseHeight,fluidParams:o.fluidParams||C.DEFAULTS.fluidParams.clone(),customParams:o.customParams||C.DEFAULTS.customParams.clone(),waterColor:o.waterColor||C.DEFAULTS.waterColor.clone(),lonLat:o.lonLat||[...C.DEFAULTS.lonLat],timeStep:o.timeStep||C.DEFAULTS.timeStep,heightMapSource:o.heightMapSource||C.DEFAULTS.heightMapSource}}_initState(){this._frameCount=0,this._isActive=!0,this._time=0}setInitialWaterLevel(o){const h=Number(o);!Number.isFinite(h)||!this.config.fluidParams||(this.config.fluidParams.w=Math.max(0,Math.min(1,h)),this.resetSimulation())}resetSimulation(){var o,h;this._frameCount=0,(h=(o=this.viewer.scene).requestRender)==null||h.call(o)}_createResources(){this._createTextures(),this._setupHeightMap(),this._createDebugVisualization()}_createTextures(){const o=()=>P.createTexture({context:this.viewer.scene.context,width:this.config.resolution.x,height:this.config.resolution.y,pixelFormat:e.PixelFormat.RGBA,pixelDatatype:e.PixelDatatype.FLOAT,arrayBufferView:new Float32Array(this.config.resolution.x*this.config.resolution.y*4)});this.textures={A:o(),B:o(),C:o(),D:o()}}_setupHeightMap(){this.heightMapCamera=this._createOrthographicCamera(),this._heightMap=this.config.heightMapSource?this._createHeightMapTexture(this.config.heightMapSource):this._generateHeightMapTexture()}_createHeightMapTexture(o){if(!(o!=null&&o.arrayBufferView)||!o.width||!o.height)throw new Error("Invalid height map source.");return P.createTexture({context:this.viewer.scene.context,width:o.width,height:o.height,flipY:!1,pixelFormat:e.PixelFormat.RGBA,pixelDatatype:e.PixelDatatype.FLOAT,arrayBufferView:o.arrayBufferView,sampler:new e.Sampler({wrapS:e.TextureWrap.CLAMP_TO_EDGE,wrapT:e.TextureWrap.CLAMP_TO_EDGE,minificationFilter:e.TextureMinificationFilter.LINEAR,magnificationFilter:e.TextureMagnificationFilter.LINEAR})})}_generateHeightMapTexture(){var k,U;const o=this.viewer.scene.context,h=P.createDepthFramebuffer(o,this.config.resolution.x,this.config.resolution.y),p=this.viewer.scene,m=p.frameState,l=n(this.viewer.scene),d=p.camera,a=m.camera,u=l.framebuffer,g=e.BoundingRectangle.clone(l.viewport,new e.BoundingRectangle);let D=null,A=[];try{l.viewport.x=0,l.viewport.y=0,l.viewport.width=this.config.resolution.x,l.viewport.height=this.config.resolution.y,l.framebuffer=h,p.camera=this.heightMapCamera,m.camera=this.heightMapCamera,m.context.uniformState.updateCamera(this.heightMapCamera),A=this._processHeightMapShaders(),this._renderDepthPrepass(l);const E=P.createTexture({context:o,width:this.config.resolution.x,height:this.config.resolution.y,flipY:!1,pixelFormat:e.PixelFormat.RGBA,pixelDatatype:e.PixelDatatype.FLOAT});return D=P.createFramebuffer(o,E),this._copyTexture(h.getColorTexture(0),D),E}finally{this._restoreHeightMapShaders(A),l.framebuffer=u,e.BoundingRectangle.clone(g,l.viewport),p.camera=d,m.camera=a,a&&m.context.uniformState.updateCamera(a),D&&!((k=D.isDestroyed)!=null&&k.call(D))&&D.destroy(),h&&!((U=h.isDestroyed)!=null&&U.call(h))&&h.destroy()}}_renderDepthPrepass(o){const h=this.viewer.scene.frameState;h.camera=this.heightMapCamera,this.viewer.scene.frameState.context.uniformState.updateCamera(this.heightMapCamera),this._getDepthRenderCommands().forEach(m=>m.execute(this.viewer.scene.context,o))}_createDebugVisualization(){this.debugEntity=this.viewer.entities.add({position:e.Cartesian3.fromDegrees(...this.config.lonLat,this.config.baseHeight+this.config.dimensions.z/2),box:{dimensions:this.config.dimensions,fill:!1,outline:!0,outlineColor:e.Color.WHITE}})}_setupRenderPipeline(){this._createComputePasses(),this._createMainRenderPass(),this._startRenderLoop()}_createComputePasses(){const o={iTime:()=>this._time,iFrame:()=>this._frameCount,resolution:()=>this.config.resolution,fluidParam:()=>this.config.fluidParams,customParam:()=>this.config.customParams,minHeight:()=>this.config.heightRange.min,maxHeight:()=>this.config.heightRange.max,heightMap:()=>this._heightMap};this.computePasses=[this._createComputePass("A",{uniforms:{...o,iChannel0:()=>this.textures.C,iChannel1:()=>this.textures.D},shaderSource:r}),this._createComputePass("B",{uniforms:{...o,iChannel0:()=>this.textures.A,iChannel1:()=>this.textures.D},shaderSource:s}),this._createComputePass("C",{uniforms:{...o,iChannel0:()=>this.textures.A,iChannel1:()=>this.textures.B},shaderSource:x}),this._createComputePass("D",{uniforms:{...o,iChannel0:()=>this.textures.C,iChannel1:()=>this.textures.B},shaderSource:v})]}_createComputePass(o,{uniforms:h,shaderSource:p}){return new T({commandType:"Compute",uniformMap:h,fragmentShaderSource:new e.ShaderSource({sources:[c,p]}),geometry:P.getFullscreenQuad(),outputTexture:this.textures[o],preExecute:m=>m.commandToExecute.outputTexture=this.textures[o]})}_createMainRenderPass(){const o=_([...this.config.lonLat,this.config.baseHeight+this.config.dimensions.z/2],[90,0,0],[this.config.dimensions.x,this.config.dimensions.z,this.config.dimensions.y]);this.mainRenderPass=new T({commandType:"Draw",uniformMap:this._getMainRenderUniforms(),vertexShaderSource:this._getVertexShader(),fragmentShaderSource:new e.ShaderSource({sources:[c,S]}),geometry:this._createBoxGeometry(),modelMatrix:o,attributeLocations:this._getAttributeLocations(),rawRenderState:this._createRenderState()})}_getMainRenderUniforms(){return{iTime:()=>this._time,iFrame:()=>this._frameCount,iResolution:()=>this.config.resolution,iChannel0:()=>this.textures.C,heightMap:()=>this._heightMap,customParam:()=>this.config.customParams,waterColor:()=>this.config.waterColor,colorTexture:()=>{var o,h,p,m;return(m=(p=(h=(o=t(this.viewer.scene))==null?void 0:o.globeDepth)==null?void 0:h.colorFramebufferManager)==null?void 0:p._colorTextures)==null?void 0:m[0]}}}_startRenderLoop(){this.postRenderHandler=this.viewer.scene.postRender.addEventListener(()=>{this._isActive&&(this._time=performance.now()/1e3,this._frameCount+=this.config.timeStep)}),this.computePasses.forEach(o=>this.viewer.scene.primitives.add(o)),this.viewer.scene.primitives.add(this.mainRenderPass)}_screenToWorld(o){const h=this.viewer.camera.getPickRay(o);return this.viewer.scene.globe.pick(h,this.viewer.scene)}_createOrthographicCamera(){const o=new e.Camera(this.viewer.scene);o.frustum=new e.OrthographicOffCenterFrustum;const[h,p]=this.config.lonLat,m=e.Cartesian3.fromDegrees(h,p,this.config.baseHeight),l=e.Transforms.eastNorthUpToFixedFrame(m),d=o.frustum;d.near=.01,d.far=Math.max(this.config.dimensions.z*2,this.config.heightRange.max-this.config.heightRange.min+this.config.dimensions.z),d.left=-this.config.dimensions.x/2,d.right=this.config.dimensions.x/2,d.bottom=-this.config.dimensions.y/2,d.top=this.config.dimensions.y/2;const a=e.Matrix4.getColumn(l,2,new e.Cartesian3);e.Cartesian3.negate(a,a);const u=e.Matrix4.getColumn(l,1,new e.Cartesian3),g=e.Matrix4.getColumn(l,0,new e.Cartesian3),D=e.Cartesian3.multiplyByScalar(a,-d.far,new e.Cartesian3);return o.position=e.Cartesian3.add(m,D,new e.Cartesian3),o.direction=a,o.up=u,o.right=g,o}destroy(){var o,h;this._isActive=!1,typeof this.postRenderHandler=="function"&&(this.postRenderHandler(),this.postRenderHandler=null),[this.mainRenderPass,...this.computePasses||[]].forEach(p=>{p&&this.viewer.scene.primitives.remove(p)}),this.mainRenderPass=null,this.computePasses=[],this.debugEntity&&(this.viewer.entities.remove(this.debugEntity),this.debugEntity=null),Object.values(this.textures||{}).forEach(p=>{var m;p&&!((m=p.isDestroyed)!=null&&m.call(p))&&p.destroy()}),this.textures={},this._heightMap&&!((h=(o=this._heightMap).isDestroyed)!=null&&h.call(o))&&(this._heightMap.destroy(),this._heightMap=null)}_copyTexture(o,h){const p=this.viewer.scene.context,m=n(this.viewer.scene),l=p.createViewportQuadCommand(`uniform sampler2D u_texToCopy;
    ...
    `;function w(){return new e.PostProcessStage({fragmentShader:M})}return{FluidRenderer:f,createSkyEffect:w}}const bo={key:0,class:"fluid-root"},So={class:"fluid-panel"},_o={class:"panel-actions"},wo=["disabled"],To={key:0,class:"selected-text"},zn=1024,zt=1e4,Nn=1200,Mo=100,Do=.01,Lo=.03,Fo=60,Qt=64,Po=160,Ao={__name:"FluidSimulationPanel",props:{headless:{type:Boolean,default:!1},getViewer:{type:Function,required:!0},getCesium:{type:Function,required:!0},params:{type:Object,default:()=>({})}},emits:["close","state-change"],setup(e,{expose:t,emit:n}){const i=e,c=n,r=dn(),s=Y(10),x=Y(20),v=Y(3),S=Y("#0d4fa3"),T=Y(null),P=Y(null),f=Y(null),_=Y(!1),M=Y(!1),w=Y(null),C=Y(null),F=Y(!1),o=Y(5);let h=null,p=null,m=null,l=null,d=null,a=null,u=null,g=null,D=0;const A=Pe(()=>!Number.isFinite(w.value)||!Number.isFinite(C.value)?"":`经度 ${w.value.toFixed(6)} / 纬度 ${C.value.toFixed(6)}`),k=Pe(()=>Number.isFinite(P.value)&&Number.isFinite(f.value)),U=Pe(()=>{if(!k.value)return 1;const L=Math.abs(f.value-P.value);return Math.max(L/1e3,.01)}),E=Pe(()=>[{id:"threshold",label:"Threshold",type:"range",min:0,max:500,step:1e-4,value:s.value,displayValue:Number(s.value).toFixed(2)},{id:"blend",label:"Blend",type:"range",min:0,max:50,step:1e-4,value:x.value,displayValue:Number(x.value).toFixed(2)},{id:"lightStrength",label:"Light",type:"range",min:0,max:10,step:1e-4,value:v.value,displayValue:Number(v.value).toFixed(2)},{id:"waterLevel",label:"Water Level",type:"range",min:k.value?P.value:0,max:k.value?f.value:1,step:U.value,value:Number.isFinite(Number(T.value))?Number(T.value):0,displayValue:k.value&&Number.isFinite(Number(T.value))?`${Number(T.value).toFixed(2)} m`:"Pick terrain first",disabled:!k.value},{id:"waterColor",label:"Water Color",type:"color",value:S.value}]);Le([s,x,v,S],z),Le(T,Q),Le(()=>i.params,L=>{te(L||{})},{deep:!0,immediate:!0}),Le([_,M,A,T,P,f,F,o],oe,{immediate:!0}),oi(()=>{ie(),Be(!0)});function G(){var q,ae;const L=(q=i.getViewer)==null?void 0:q.call(i),I=((ae=i.getCesium)==null?void 0:ae.call(i))||window.Cesium;if(!L||!I)return r.warning("Cesium 场景尚未就绪。"),null;if(!m){const le=xo(I);m=le.FluidRenderer,l=le.createSkyEffect}return{viewer:L,Cesium:I}}function te(L){Number.isFinite(Number(L.threshold))&&(s.value=Number(L.threshold)),Number.isFinite(Number(L.blend))&&(x.value=Number(L.blend)),Number.isFinite(Number(L.lightStrength))&&(v.value=Number(L.lightStrength)),$e(L.waterColor)&&(S.value=L.waterColor),Number.isFinite(Number(L.waterLevel))&&(T.value=Number(L.waterLevel))}function J({controlId:L,value:I}){L==="threshold"?s.value=Number(I):L==="blend"?x.value=Number(I):L==="lightStrength"?v.value=Number(I):L==="waterLevel"?T.value=Number(I):L==="waterColor"&&$e(I)&&(S.value=I)}function oe(){c("state-change",{isPicking:_.value,hasFluid:M.value,selectedText:A.value,waterLevel:T.value,waterLevelMin:P.value,waterLevelMax:f.value,floodSimActive:F.value,floodSpeed:o.value})}function ye(){const L=G();if(!L)return;const{viewer:I,Cesium:q}=L;ve(),K(I,q),_.value=!0,d=new q.ScreenSpaceEventHandler(I.scene.canvas),d.setInputAction(ae=>{ue(I,q,ae.position)},q.ScreenSpaceEventType.LEFT_CLICK)}async function ue(L,I,q){var Te,Fe;const ae=N(L,q);if(!ae){r.warning("未选中可用地形位置。");return}const le=++D;ve();const ge=I.Cartographic.fromCartesian(ae),y=I.Math.toDegrees(ge.longitude),R=I.Math.toDegrees(ge.latitude),j=Number(ge.height),V=Number.isFinite(j)?j:0,me=new I.Cartesian3(zt,zt,0);li("正在请求模拟范围高度数据...");try{Ne();const Ee=Number(s.value)||0,B=Number(x.value)||0,X=Number(v.value)||0,se=await Ce(L,I,{lon:y,lat:R,centerHeight:V,dimensions:me}),fe=ke(se,V),je=fe.baseHeight,Ge=fe.depth,ct=Ue(fe,V),Ct=new I.Cartesian3(zt,zt,Ge);if(le!==D)return;P.value=fe.minHeight,f.value=fe.maxHeight,T.value=ct;const St=Math.abs(fe.maxHeight-fe.minHeight);St>0&&(o.value=Math.max(St/10,.1)),se||r.warning("范围高度预请求不可用，已回退到当前场景捕捉。",{duration:4200}),a=new m(L,{lonLat:[y,R],width:zn,height:zn,dimensions:Ct,baseHeight:je,minHeight:fe.minHeight,maxHeight:fe.maxHeight,heightMapSource:se,waterColor:He(I,S.value),customParams:new I.Cartesian4(Ee,B,X,10),fluidParams:new I.Cartesian4(.9+X/10*.099,Math.min(1,B/50),Ee/5e4,We(ct,fe))}),w.value=y,C.value=R,M.value=!0,(Fe=(Te=L.scene).requestRender)==null||Fe.call(Te),r.success("水体流体已创建。")}catch(Ee){r.error("水体流体创建失败",Ee),r.warning("当前显卡或 Cesium 版本可能不支持该流体渲染管线。",{closable:!0})}finally{ci()}}async function Ce(L,I,q){const ae=L==null?void 0:L.terrainProvider,le=De(q.dimensions);if(!ae)return null;if(I.EllipsoidTerrainProvider&&ae instanceof I.EllipsoidTerrainProvider)return we(le);if(typeof I.sampleTerrain!="function"&&typeof I.sampleTerrainMostDetailed!="function")return null;try{return await Oe(L,I,q,le)}catch(ge){if(le<=Qt)throw ge;return Oe(L,I,q,Qt)}}async function Oe(L,I,q,ae){const le=$(I,q,ae),ge=await O(I,L.terrainProvider,le);return Ie(ge||le,{size:ae})}function De(L){const I=Math.max(Number(L==null?void 0:L.x)||0,Number(L==null?void 0:L.y)||0),q=Math.ceil(I/Fo)+1;return W(q,Qt,Po)}function W(L,I,q){return Math.max(I,Math.min(q,Math.round(L)))}function $(L,{lon:I,lat:q,centerHeight:ae,dimensions:le},ge){const y=L.Cartesian3.fromDegrees(I,q,ae),R=L.Transforms.eastNorthUpToFixedFrame(y),j=[],V=Math.max(1,ge-1);for(let me=0;me<ge;me++){const Fe=(.5-me/V)*le.y;for(let Ee=0;Ee<ge;Ee++){const X=(Ee/V-.5)*le.x,se=new L.Cartesian3(X,Fe,0),fe=L.Matrix4.multiplyByPoint(R,se,new L.Cartesian3);j.push(L.Cartographic.fromCartesian(fe))}}return j}async function O(L,I,q){const ae=de(I),le=Number.isInteger(ae)?ae:Math.min((I==null?void 0:I.maximumLevel)??12,12);return typeof L.sampleTerrain=="function"?L.sampleTerrain(I,le,q):L.sampleTerrainMostDetailed(I,q)}function de(L){const I=Number(L==null?void 0:L._bottomLevel);return Number.isFinite(I)?Math.max(0,I-1):null}function Ie(L,{size:I}){var le;const q=Ae(L);if(!q)return null;const ae=new Float32Array(I*I*4);for(let ge=0;ge<I*I;ge++){const y=Number((le=L[ge])==null?void 0:le.height),R=ge*4;ae[R]=Number.isFinite(y)?ze(y,q.minHeight,q.maxHeight):q.minHeight,ae[R+1]=0,ae[R+2]=0,ae[R+3]=1}return{width:I,height:I,arrayBufferView:ae,minHeight:q.minHeight,maxHeight:q.maxHeight}}function we(L){return{width:L,height:L,arrayBufferView:new Float32Array(L*L*4),minHeight:0,maxHeight:0}}function Ae(L){let I=Number.POSITIVE_INFINITY,q=Number.NEGATIVE_INFINITY;for(const ae of L||[]){const le=Number(ae==null?void 0:ae.height);Number.isFinite(le)&&(I=Math.min(I,le),q=Math.max(q,le))}return!Number.isFinite(I)||!Number.isFinite(q)?null:{minHeight:I,maxHeight:q}}function ke(L,I){const q=Number(L==null?void 0:L.minHeight),ae=Number(L==null?void 0:L.maxHeight);if(Number.isFinite(q)&&Number.isFinite(ae)){const y=Number(I),R=Number.isFinite(y)?Math.min(q,ae,y):Math.min(q,ae),j=Number.isFinite(y)?Math.max(q,ae,y):Math.max(q,ae),V=Math.max(j-R,Do);return{baseHeight:R,depth:V,minHeight:R,maxHeight:R+V}}const le=Number(I),ge=Number.isFinite(le)?le-Mo:0;return{baseHeight:ge,depth:Nn,minHeight:ge,maxHeight:ge+Nn}}function Ue(L,I){const q=L.minHeight+L.depth*Lo,ae=Number(I),le=Number.isFinite(ae)?ae:q;return ze(le,L.minHeight,L.maxHeight)}function We(L,I){const q=I.maxHeight-I.minHeight;return!Number.isFinite(q)||q<=0?0:ze((L-I.minHeight)/q,0,1)}function he(){return!Number.isFinite(P.value)||!Number.isFinite(f.value)?null:{minHeight:Math.min(P.value,f.value),maxHeight:Math.max(P.value,f.value)}}function He(L,I){const q=qe(I)||qe("#0d4fa3");return new L.Cartesian3(q.red,q.green,q.blue)}function Ye(){var q;const L=qe(S.value),I=(q=a==null?void 0:a.config)==null?void 0:q.waterColor;!L||!I||(I.x=L.red,I.y=L.green,I.z=L.blue)}function $e(L){return typeof L=="string"&&/^#[0-9a-f]{6}$/i.test(L)}function qe(L){return $e(L)?{red:Number.parseInt(L.slice(1,3),16)/255,green:Number.parseInt(L.slice(3,5),16)/255,blue:Number.parseInt(L.slice(5,7),16)/255}:null}function ze(L,I,q){return Math.max(I,Math.min(q,L))}function N(L,I){if(!I)return null;if(L.scene.pickPositionSupported&&typeof L.scene.pickPosition=="function"){const ae=L.scene.pickPosition(I);if(ae)return ae}const q=L.camera.getPickRay(I);return q?L.scene.globe.pick(q,L.scene):null}function z(){var ae,le,ge;if(!(a!=null&&a.config))return;const L=Number(s.value)||0,I=Number(x.value)||0,q=Number(v.value)||0;a.config.customParams&&(a.config.customParams.x=L,a.config.customParams.y=I,a.config.customParams.z=q),a.config.fluidParams&&(a.config.fluidParams.x=.9+q/10*.099,a.config.fluidParams.y=Math.min(1,I/50),a.config.fluidParams.z=L/5e4),Ye(),(ge=(le=(ae=a.viewer)==null?void 0:ae.scene)==null?void 0:le.requestRender)==null||ge.call(le)}function Q(){var le,ge,y,R;if(!((le=a==null?void 0:a.config)!=null&&le.fluidParams))return;const L=he(),I=Number(T.value);if(!L||!Number.isFinite(I))return;const q=ze(I,L.minHeight,L.maxHeight);if(q!==I){T.value=q;return}const ae=We(q,L);typeof a.setInitialWaterLevel=="function"?a.setInitialWaterLevel(ae):(a.config.fluidParams.w=ae,(R=(y=(ge=a.viewer)==null?void 0:ge.scene)==null?void 0:y.requestRender)==null||R.call(y))}function K(L,I){var q,ae;if(!g){const le=L.scene;g={shadows:L.shadows,resolutionScale:L.resolutionScale,msaaSamples:le.msaaSamples,depthTestAgainstTerrain:le.globe.depthTestAgainstTerrain,logarithmicDepthBuffer:le.logarithmicDepthBuffer,highDynamicRange:le.highDynamicRange,fogEnabled:(q=le.fog)==null?void 0:q.enabled,showGroundAtmosphere:le.globe.showGroundAtmosphere,skyAtmosphereShow:(ae=le.skyAtmosphere)==null?void 0:ae.show,enableLighting:le.globe.enableLighting}}L.shadows=!0,L.resolutionScale=1,L.scene.msaaSamples=4,L.scene.globe.depthTestAgainstTerrain=!0,L.scene.logarithmicDepthBuffer=!0,L.scene.highDynamicRange=!0,L.scene.fog&&(L.scene.fog.enabled=!0),L.scene.globe.showGroundAtmosphere=!0,L.scene.skyAtmosphere&&(L.scene.skyAtmosphere.show=!0),L.scene.globe.enableLighting=!0,!u&&l&&(u=l(I),L.scene.postProcessStages.add(u))}function ne(L){if(!L||!g)return;const I=L.scene;L.shadows=g.shadows,L.resolutionScale=g.resolutionScale,g.msaaSamples!==void 0&&(I.msaaSamples=g.msaaSamples),I.globe.depthTestAgainstTerrain=g.depthTestAgainstTerrain,I.logarithmicDepthBuffer=g.logarithmicDepthBuffer,I.highDynamicRange=g.highDynamicRange,I.fog&&g.fogEnabled!==void 0&&(I.fog.enabled=g.fogEnabled),I.globe.showGroundAtmosphere=g.showGroundAtmosphere,I.skyAtmosphere&&g.skyAtmosphereShow!==void 0&&(I.skyAtmosphere.show=g.skyAtmosphereShow),I.globe.enableLighting=g.enableLighting,g=null}function H(){F.value?ie():Z()}function Z(){const L=he();if(!L)return;const I=Number(T.value);(!Number.isFinite(I)||I>=L.maxHeight-.01)&&(T.value=L.minHeight),F.value=!0,p=null;function q(ae){if(!F.value)return;p===null&&(p=ae);const le=Math.min((ae-p)/1e3,.1);p=ae;const ge=he();if(!ge){ie();return}const R=Number(T.value)+o.value*le;if(R>=ge.maxHeight){T.value=ge.maxHeight,ie(),r.info("洪水模拟完成：水位已达最大值");return}T.value=R,h=requestAnimationFrame(q)}h=requestAnimationFrame(q),r.info("洪水模拟开始")}function ie(){F.value=!1,p=null,h!==null&&(cancelAnimationFrame(h),h=null)}function re(){ie(),Be(!1),r.success("水体流体已清除。")}function ve(){d&&(d.destroy(),d=null),_.value=!1}function Ne(){if(a){try{a.destroy()}catch{}a=null,M.value=!1}}function Be(L){var q,ae,le;const I=(q=i.getViewer)==null?void 0:q.call(i);if(D+=1,ie(),ve(),Ne(),w.value=null,C.value=null,T.value=null,P.value=null,f.value=null,I&&u){try{I.scene.postProcessStages.remove(u)}catch{}u=null}L&&I&&ne(I),(le=(ae=I==null?void 0:I.scene)==null?void 0:ae.requestRender)==null||le.call(ae)}function Me(){Be(!0),c("close")}function Je(L){const I=Number(L);Number.isFinite(I)&&I>0&&(o.value=I)}return t({startPickHeightMap:ye,clearFluid:re,toggleFloodSimulation:H,stopFloodSimulation:ie,setFloodSpeed:Je}),(L,I)=>e.headless?xe("",!0):(ee(),ce("div",bo,[b("div",So,[b("div",{class:"panel-head"},[I[0]||(I[0]=b("span",{class:"panel-title"},"水体流体",-1)),b("button",{class:"panel-close",title:"关闭",onClick:Me}," × ")]),b("div",_o,[b("button",{class:Xe(["action-btn primary",{active:_.value}]),onClick:ye},be(_.value?"等待选点":"捕捉高度图"),3),b("button",{class:"action-btn",disabled:!M.value&&!_.value,onClick:re}," 清除 ",8,wo)]),A.value?(ee(),ce("div",To,be(A.value),1)):xe("",!0),Re(pn,{class:"param-list",title:"Fluid Parameters",controls:E.value,onChange:J},null,8,["controls"])])]))}},Co=nt(Ao,[["__scopeId","data-v-2de8b792"]]),Eo=`
  uniform float uTime;
...
`;function No(e=256){const t=new Float32Array(e*e);for(let f=0;f<e*e;f++)t[f]=Math.random();const n=(f,_)=>{const M=new Float32Array(e*e);for(let w=0;w<e;w++)for(let C=0;C<e;C++){let F=0,o=0;for(let h=-_;h<=_;h++)for(let p=-_;p<=_;p++)F+=f[(w+h+e)%e*e+(C+p+e)%e],o++;M[w*e+C]=F/o}return M},i=n(t,4),c=n(t,1),r=new Float32Array(e*e);for(let f=0;f<e*e;f++)r[f]=i[f]*.7+c[f]*.3;const s=document.createElement("canvas");s.width=s.height=e;const x=s.getContext("2d"),v=x.createImageData(e,e),S=(f,_)=>r[(_+e)%e*e+(f+e)%e],T=3;for(let f=0;f<e;f++)for(let _=0;_<e;_++){const M=(S(_-1,f)-S(_+1,f))*T,w=(S(_,f-1)-S(_,f+1))*T,C=Math.hypot(M,w,1),F=(f*e+_)*4;v.data[F]=(M/C*.5+.5)*255,v.data[F+1]=(w/C*.5+.5)*255,v.data[F+2]=(1/C*.5+.5)*255,v.data[F+3]=255}x.putImageData(v,0,0);const P=new hn(s);return P.wrapS=P.wrapT=fn,P.colorSpace=di,P}function Oo(){const e=document.createElement("canvas");e.width=e.height=512;const t=e.getContext("2d");t.fillStyle="#d8c79b",t.fillRect(0,0,512,512);for(let i=0;i<12e3;i++){const c=170+Math.random()*70|0;t.fillStyle=`rgba(${c},${c-22},${c-65},0.22)`,t.fillRect(Math.random()*512,Math.random()*512,1.6,1.6)}for(let i=0;i<26;i++){const c=60+Math.random()*40|0,r=90+Math.random()*50|0,s=70+Math.random()*40|0;t.fillStyle=`rgba(${c},${r},${s},0.30)`,t.beginPath(),t.ellipse(Math.random()*512,Math.random()*512,8+Math.random()*26,6+Math.random()*20,Math.random()*6,0,7),t.fill()}const n=new hn(e);return n.wrapS=n.wrapT=fn,n.repeat.set(10,10),n.colorSpace=Ri,n}function Ho(e=256){const t=(S,T)=>{const P=new Float32Array(e*e);for(let f=0;f<e;f++)for(let _=0;_<e;_++){let M=0,w=0;for(let C=-T;C<=T;C++)for(let F=-T;F<=T;F++)M+=S[(f+C+e)%e*e+(_+F+e)%e],w++;P[f*e+_]=M/w}return P},n=()=>{const S=new Float32Array(e*e);for(let w=0;w<e*e;w++)S[w]=Math.random();const T=t(S,3),P=t(S,1),f=new Float32Array(e*e);let _=1e9,M=-1e9;for(let w=0;w<e*e;w++)f[w]=T[w]*.65+P[w]*.35,_=Math.min(_,f[w]),M=Math.max(M,f[w]);for(let w=0;w<e*e;w++)f[w]=(f[w]-_)/(M-_);return f},i=n(),c=n(),r=document.createElement("canvas");r.width=r.height=e;const s=r.getContext("2d"),x=s.createImageData(e,e);for(let S=0;S<e*e;S++){const T=S*4;x.data[T]=i[S]*255,x.data[T+1]=c[S]*255,x.data[T+2]=0,x.data[T+3]=255}s.putImageData(x,0,0);const v=new hn(r);return v.wrapS=v.wrapT=fn,v.colorSpace=di,v.minFilter=Ln,v.magFilter=Ln,v.generateMipmaps=!1,v}function Bo(e={}){const{onReady:t,onError:n,onFpsUpdate:i}=e,c=Y(!1),r=Y(0);let s=null,x=null,v=null,S=null,T=null,P=null,f=null,_=null,M=null,w=null,C=null,F=null,o=null;const h=new at;let p=null,m=null,l=null;const d=new Ii;let a=0,u=0;const g={value:0},D={value:.9},A={value:0},k={value:new at};let U=3,E=-100;const G=.62,te={};let J=!0,oe=null;const ye=new Fn,ue={elevation:30,azimuth:150,clarity:.085,causticStrength:.9,waterColor:"#2bb3c4",waveHeight:.5,foamWidth:2.4,reflection:.38,cloudCoverage:.58,lightningEnabled:!0,lightningInterval:2};async function Ce(H){if(!H){n==null||n(new Error("Container element not provided"));return}if(!c.value){P=H;try{v=new ki({antialias:!0,alpha:!0}),v.setPixelRatio(Math.min(window.devicePixelRatio,2)),v.setSize(P.clientWidth,P.clientHeight),v.toneMapping=zi,v.toneMappingExposure=G,v.setClearColor(0,0),P.appendChild(v.domElement),s=new Fn,x=new Ni(55,P.clientWidth/P.clientHeight,1,2e4),x.position.set(0,55,280),Oe(),Ie(),we(),De(),W(),$(),O(),de(),We(),he(),qe(),c.value=!0,t==null||t()}catch(Z){n==null||n(Z)}}}function Oe(){F=new Oi,F.scale.setScalar(12e3),s.add(F);const H=F.material.uniforms;H.turbidity.value=6,H.rayleigh.value=1.6,H.mieCoefficient.value=.005,H.mieDirectionalG.value=.8}function De(){o=new $i(16774368,2.6),s.add(o),s.add(new qi(13627391,2117738,.7))}function W(){const H=new An(1600,1600,200,200);H.rotateX(-Math.PI/2);const Z=H.attributes.position;for(let re=0;re<Z.count;re++){const ve=Z.getX(re),Ne=Z.getZ(re);let Me=-34+It.clamp((Ne+800)/1600,0,1)*44;Me+=Math.sin(ve*.012)*Math.cos(Ne*.014)*3.5,Me+=Math.sin(ve*.06+Ne*.05)*1.1,Me+=(Math.random()-.5)*.6,Z.setY(re,Me)}H.computeVertexNormals();const ie=new Cn({map:Oo(),roughness:1,metalness:0});On(ie,{uTime:g,uCaustic:D}),s.add(new wt(H,ie))}function $(){const H=new ji(1,0),Z=[8023642,7035722,11887946,13598051,9083483];for(let ie=0;ie<30;ie++){const re=new Cn({color:Z[ie%Z.length],roughness:.9,flatShading:!0});On(re,{uTime:g,uCaustic:D});const ve=new wt(H,re),Ne=3+Math.random()*9;ve.scale.set(Ne,Ne*(.5+Math.random()*.6),Ne),ve.position.set((Math.random()-.5)*1100,-24+Math.random()*22,-300+Math.random()*900),ve.rotation.set(Math.random(),Math.random(),Math.random()),s.add(ve)}}function O(){C=new Vi(v),w=new Xi(256,{generateMipmaps:!0,minFilter:Yi}),M=new Ki(1,2e4,w),M.position.set(0,4,0),s.add(M);const H=new Jt;v.getDrawingBufferSize(H),_=new Zi(H.x,H.y),_.depthTexture=new Ji(H.x,H.y),_.depthTexture.type=Qi,_.depthTexture.format=ea}function de(){const H=new Jt;v.getDrawingBufferSize(H);const Z=No(256),ie={uTime:g,tRefraction:{value:_.texture},tDepth:{value:_.depthTexture},tEnv:{value:w.texture},normalMap:{value:Z},resolution:{value:H.clone()},cameraNear:{value:x.near},cameraFar:{value:x.far},invProjection:{value:new En},camWorld:{value:new En},sunDirection:{value:new at},sunColor:{value:new _t(16774106)},waterColor:{value:new _t(ue.waterColor)},absorption:{value:new at(.45,.09,.05)},foamColor:{value:new _t(15925247)},clarity:{value:ue.clarity},foamWidth:{value:ue.foamWidth},waveHeight:{value:ue.waveHeight},reflection:{value:ue.reflection}};f=new wt(new An(16e3,16e3,384,384),new Pn({uniforms:ie,vertexShader:Ro,fragmentShader:Io})),f.rotation.x=-Math.PI/2,s.add(f)}function Ie(){const H=new Pn({side:Hi,transparent:!0,depthWrite:!1,uniforms:{uTime:g,uNoise:{value:Ho(256)},sunDirection:{value:new at},sunColor:{value:new _t(16773341)},skyTint:{value:new _t(7315406)},uCoverage:{value:ue.cloudCoverage},uFlash:A,uFlashPos:k},vertexShader:ko,fragmentShader:zo});p=new wt(new Bi(8e3,32,16),H),p.renderOrder=2,s.add(p)}function we(){l=new Ui({color:14478335,transparent:!0,opacity:0,blending:Wi,depthWrite:!1,depthTest:!1}),m=new Gi,m.visible=!1,s.add(m)}function Ae(H,Z,ie,re,ve,Ne){const Be=[];let Me=H,Je=Z;const L=Math.max(5,Math.floor((ie-re)/80));for(let ae=0;ae<=L;ae++){const le=ae/L;Be.push(new at(Me,ie+(re-ie)*le,Je)),Me+=(Math.random()-.5)*ve,Je+=(Math.random()-.5)*ve}const I=new na(new ia(Be),L*4,Ne,5,!1),q=new wt(I,l);return q.renderOrder=3,m.add(q),Be}function ke(){for(const re of m.children)re.geometry.dispose();m.clear();const H=1+Math.floor(Math.random()*3);let Z=0,ie=0;for(let re=0;re<H;re++){const ve=(Math.random()-.5)*5e3,Ne=-(1e3+Math.random()*4500);re===0&&(Z=ve,ie=Ne);const Be=Ae(ve,Ne,1180,18,110,14),Me=2+Math.floor(Math.random()*3);for(let Je=0;Je<Me;Je++){const L=Be[2+Math.floor(Math.random()*(Be.length-4))];Ae(L.x,L.z,L.y,L.y-(160+Math.random()*420),130,7)}}k.value.set(Z,1100,ie)}function Ue(){if(!ue.lightningEnabled){A.value=0,m.visible=!1,v.toneMappingExposure=G;return}const H=g.value;H>=U&&(E=H,ke(),U=H+ue.lightningInterval*(.4+Math.random()*.8));const Z=H-E;let ie=0;Z>=0&&Z<.5&&(ie=Math.max(0,Math.exp(-Z*5.5)*(.5+.5*Math.sin(Z*60)))),A.value=ie*2.4,m.visible=ie>.1,l.opacity=Math.min(1,ie*1.7),v.toneMappingExposure=G+ie*.75}function We(){S=new ta(x,v.domElement),S.target.set(0,130,-400),S.maxPolarAngle=Math.PI*.49,S.minDistance=30,S.maxDistance=2e3,S.enableDamping=!0}function he(){window.addEventListener("keydown",He),window.addEventListener("keyup",Ye)}function He(H){const Z=H.target&&H.target.tagName;Z==="INPUT"||Z==="TEXTAREA"||(te[H.code]=!0)}function Ye(H){te[H.code]=!1}function $e(H){const Z=(te.ShiftLeft||te.ShiftRight?240:95)*H,ie=new at,re=new at,ve=new at;x.getWorldDirection(ie).normalize(),re.crossVectors(ie,x.up).normalize(),ve.set(0,0,0),te.KeyW&&ve.add(ie),te.KeyS&&ve.addScaledVector(ie,-1),te.KeyD&&ve.add(re),te.KeyA&&ve.addScaledVector(re,-1),te.KeyE&&(ve.y+=1),te.KeyQ&&(ve.y-=1),ve.lengthSq()!==0&&(ve.normalize().multiplyScalar(Z),x.position.add(ve),S.target.add(ve),x.position.y<2.5&&(x.position.y=2.5))}function qe(){const H=It.degToRad(90-ue.elevation),Z=It.degToRad(ue.azimuth);if(h.setFromSphericalCoords(1,H,Z),F.material.uniforms.sunPosition.value.copy(h),o.position.copy(h).multiplyScalar(1e3),f&&f.material.uniforms.sunDirection.value.copy(h).normalize(),p){p.material.uniforms.sunDirection.value.copy(h).normalize();const ie=It.clamp(1-ue.elevation/28,0,1);p.material.uniforms.sunColor.value.setRGB(1,.95-.22*ie,.86-.48*ie)}s.remove(F),ye.add(F),oe&&oe.dispose(),oe=C.fromScene(ye),s.environment=oe.texture,ye.remove(F),s.add(F),J=!0}function ze(){T=requestAnimationFrame(ze);const H=d.getDelta();g.value+=H,D.value=ue.causticStrength,$e(H),Ue(),S.update(),x.updateMatrixWorld(),f.material.uniforms.invProjection.value.copy(x.projectionMatrixInverse),f.material.uniforms.camWorld.value.copy(x.matrixWorld),f.visible=!1,J&&(M.update(v,s),J=!1),p.visible=!1;const Z=m.visible;m.visible=!1,v.setRenderTarget(_),v.render(s,x),v.setRenderTarget(null),p.visible=!0,m.visible=Z,f.visible=!0,v.render(s,x),a++;const ie=performance.now();ie-u>=1e3&&(r.value=Math.round(a*1e3/(ie-u)),i==null||i(r.value),a=0,u=ie)}function N(){if(!x||!v||!P)return;const H=P.clientWidth,Z=P.clientHeight;x.aspect=H/Z,x.updateProjectionMatrix(),v.setSize(H,Z);const ie=new Jt;v.getDrawingBufferSize(ie),_.setSize(ie.x,ie.y),f.material.uniforms.resolution.value.copy(ie)}function z(){T||(d.start(),ze())}function Q(){T&&(cancelAnimationFrame(T),T=null)}function K(H){const Z={...ue};Object.assign(ue,H),(H.elevation!==Z.elevation||H.azimuth!==Z.azimuth)&&qe(),f&&(H.clarity!==Z.clarity&&(f.material.uniforms.clarity.value=H.clarity),H.waveHeight!==Z.waveHeight&&(f.material.uniforms.waveHeight.value=H.waveHeight),H.foamWidth!==Z.foamWidth&&(f.material.uniforms.foamWidth.value=H.foamWidth),H.reflection!==Z.reflection&&(f.material.uniforms.reflection.value=H.reflection),H.waterColor!==Z.waterColor&&f.material.uniforms.waterColor.value.set(H.waterColor)),H.causticStrength!==Z.causticStrength&&(D.value=H.causticStrength),H.cloudCoverage!==Z.cloudCoverage&&p&&(p.material.uniforms.uCoverage.value=H.cloudCoverage)}function ne(){Q(),window.removeEventListener("keydown",He),window.removeEventListener("keyup",Ye),v&&(v.dispose(),P==null||P.removeChild(v.domElement)),s==null||s.traverse(H=>{H.geometry&&H.geometry.dispose(),H.material&&(Array.isArray(H.material)?H.material.forEach(Z=>Z.dispose()):H.material.dispose())}),_==null||_.dispose(),w==null||w.dispose(),oe==null||oe.dispose(),C==null||C.dispose(),s=null,x=null,v=null,S=null,f=null,F=null,o=null,p=null,m=null,l=null,c.value=!1}return $t(()=>{ne()}),{isReady:c,fps:r,init:Ce,start:z,pause:Q,dispose:ne,handleResize:N,updateParams:K}}const Uo={__name:"ShallowWaterOverlay",props:{visible:{type:Boolean,default:!1},elevation:{type:Number,default:30},azimuth:{type:Number,default:150},clarity:{type:Number,default:.085},causticStrength:{type:Number,default:.9},waterColor:{type:String,default:"#2bb3c4"},waveHeight:{type:Number,default:.5},foamWidth:{type:Number,default:2.4},reflection:{type:Number,default:.38},cloudCoverage:{type:Number,default:.58},lightningEnabled:{type:Boolean,default:!0},lightningInterval:{type:Number,default:2}},emits:["ready","error","fps-update"],setup(e,{expose:t,emit:n}){const i=e,c=n,r=Y(null),{isReady:s,fps:x,init:v,start:S,pause:T,dispose:P,handleResize:f,updateParams:_}=Bo({onReady:()=>c("ready"),onError:F=>c("error",F),onFpsUpdate:F=>c("fps-update",F)});Le(()=>i.visible,async F=>{F?(await M(),S()):T()}),Le(()=>[i.elevation,i.azimuth,i.clarity,i.causticStrength,i.waterColor,i.waveHeight,i.foamWidth,i.reflection,i.cloudCoverage,i.lightningEnabled,i.lightningInterval],()=>{w()});async function M(){!r.value||s.value||(await v(r.value),w())}function w(){_({elevation:i.elevation,azimuth:i.azimuth,clarity:i.clarity,causticStrength:i.causticStrength,waterColor:i.waterColor,waveHeight:i.waveHeight,foamWidth:i.foamWidth,reflection:i.reflection,cloudCoverage:i.cloudCoverage,lightningEnabled:i.lightningEnabled,lightningInterval:i.lightningInterval})}function C(){f()}return ln(()=>{window.addEventListener("resize",C),i.visible&&M()}),$t(()=>{window.removeEventListener("resize",C),P()}),t({isReady:s,fps:x,start:S,pause:T}),(F,o)=>et((ee(),ce("div",{ref_key:"canvasContainerRef",ref:r,class:"shallow-water-overlay"},null,512)),[[pt,e.visible]])}},Wo=nt(Uo,[["__scopeId","data-v-e9c0d469"]]),gn="https://cdn.jsdelivr.net/npm/cesium@1.122/Build/Cesium/",Go=`${gn}Cesium.js`,$o=`${gn}Widgets/widgets.css`;async function qo({ionToken:e}={}){window.CESIUM_BASE_URL||(window.CESIUM_BASE_URL=gn),await Vo($o,"cesium-widgets-style"),await jo(Go,"cesium-runtime-script");const t=window.Cesium;if(!t)throw new Error("Cesium global 未找到（window.Cesium 为空）");return Ut(t,e),t}function Ut(e,t){t&&(e!=null&&e.Ion)&&(e.Ion.defaultAccessToken=t)}function jo(e,t){return new Promise((n,i)=>{const c=document.getElementById(t);if(c){if(c.getAttribute("data-loaded")==="true"){n();return}c.addEventListener("load",()=>n(),{once:!0}),c.addEventListener("error",()=>i(new Error(`脚本加载失败: ${e}`)),{once:!0});return}const r=document.createElement("script");r.id=t,r.src=e,r.async=!0,r.onload=()=>{r.setAttribute("data-loaded","true"),n()},r.onerror=()=>i(new Error(`脚本加载失败: ${e}`)),document.head.appendChild(r)})}function Vo(e,t){return new Promise((n,i)=>{if(document.getElementById(t)){n();return}const r=document.createElement("link");r.id=t,r.rel="stylesheet",r.href=e,r.onload=()=>n(),r.onerror=()=>i(new Error(`样式加载失败: ${e}`)),document.head.appendChild(r)})}const Xo="Asia/Shanghai",Yo="UTC+8",Ko=new Intl.DateTimeFormat("zh-CN",{timeZone:Xo,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"});function Zo(e,t){var n,i,c,r,s,x,v;if(!(!e||!(t!=null&&t.JulianDate))){if((n=e.animation)!=null&&n.viewModel&&(e.animation.viewModel.dateFormatter=(...S)=>Qo(e,t,...S),e.animation.viewModel.timeFormatter=(...S)=>es(e,t,...S)),e.timeline){const S=(...T)=>ts(e,t,...T);e.timeline.makeLabel=S,"_makeLabel"in e.timeline&&(e.timeline._makeLabel=S),(c=(i=e.timeline).updateFromClock)==null||c.call(i),(s=(r=e.timeline).zoomTo)==null||s.call(r,e.clock.startTime,e.clock.stopTime)}(v=(x=e.scene).requestRender)==null||v.call(x)}}function vn(e,t,...n){var x;const i=n.find(Jo)||((x=e==null?void 0:e.clock)==null?void 0:x.currentTime);if(!i)return{year:"0000",month:"01",day:"01",hour:"00",minute:"00",second:"00"};const c=t.JulianDate.toDate(i),r=Ko.formatToParts(c),s=Object.fromEntries(r.filter(({type:v})=>v!=="literal").map(({type:v,value:S})=>[v,S]));return{year:s.year||"0000",month:s.month||"01",day:s.day||"01",hour:s.hour||"00",minute:s.minute||"00",second:s.second||"00"}}function Jo(e){return e&&typeof e.dayNumber=="number"&&typeof e.secondsOfDay=="number"}function Qo(e,t,...n){const{year:i,month:c,day:r}=vn(e,t,...n);return`${i}-${c}-${r}`}function es(e,t,...n){const{hour:i,minute:c,second:r}=vn(e,t,...n);return`${i}:${c}:${r} ${Yo}`}function ts(e,t,...n){const{month:i,day:c,hour:r,minute:s}=vn(e,t,...n);return`${i}-${c} ${r}:${s}`}function ns({getViewer:e}){let t=null,n=null;function i(){var x;const s=e==null?void 0:e();if(s&&((x=s._cesiumWidget)!=null&&x._creditContainer&&(s._cesiumWidget._creditContainer.style.display="none"),c(),t=setInterval(()=>{const v=document.querySelector(".cesium-credit-container");v&&v.innerHTML.length>0&&(v.innerHTML="",v.style.cssText="display: none !important; visibility: hidden !important; width: 0 !important; height: 0 !important;")},500),!document.getElementById("cesium-credit-override"))){const v=document.createElement("style");v.id="cesium-credit-override",v.textContent=`
